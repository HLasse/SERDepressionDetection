...
ggsave("publication/figs/fig1.pdf", dpi="retina", width = 10, height = 8)
```
...
ggsave("publication/figs/fig2.pdf", dpi="retina", width = 10, height = 8)
```
...
ggsave("publication/figs/fig3.pdf", dpi="retina", width = 10, height = 8)
```
...
ggsave("publication/supplementary/fig_s1.pdf", dpi="retina", width = 12.5, height = 10)
```
...
ggsave("publication/supplementary/fig_s2.pdf", dpi="retina", width = 10, height = 8)
...
ggsave("publication/supplementary/fig_s3.pdf", dpi="retina", width = 10, height = 8, device = cairo_pdf)
```
...
ggsave("publication/supplementary/fig_s4.pdf", dpi="retina", width = 10, height = 8)
```
...
ggsave("publication/supplementary/fig_s5.pdf", dpi="retina", width = 10, height = 8)
```
...
ggsave("publication/supplementary/fig_s6.pdf", dpi="retina", width = 10, height = 8)
```
...
posterior_samples(mix_m) %>% 
  ...
  gather() %>% 
  mutate(is_prior = if_else(substr(key, 1, 5) == "prior", TRUE, FALSE),
...
ggsave("publication/supplementary/fig_s7.pdf", dpi="retina", width = 10, height = 8)
```
